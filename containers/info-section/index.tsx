  ...
  return (
    <section className="w-full flex justify-center">
        <div className="w-full max-w-screen-lg mx-8 flex flex-col gap-10 py-4">
          <div>
            <h1 className="text-2xl md:text-4xl font-urbanist text-black dark:text-white">👋 {welcome} <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-black font-söhne">Saiful Islam</span></h1>
          </div>
          <div>
